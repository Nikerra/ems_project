...
import ru.sberbank.jd.java_reboot_ems_project_2023.dao.entity.UserAdminResp;
import ru.sberbank.jd.java_reboot_ems_project_2023.dao.repository.UserAdminRespRepository;
...
public class UserAdminRespService {
    ...
    public List<UserAdminResp> getUserAdminRespByUser(Long  id) {return userAdminRespRepository.findAllByUserId(id);}
